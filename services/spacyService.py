...
def GetAttributes(text: str):    
    doc = nlp(text)
    desired_labels = {label for label in LABELS_NLP}
...
def load_train_data():
    ...
    (
        "Здравствуйте, я Смирнов Алексей, 25 лет, из Ленинградской области, город Санкт-Петербург, учусь в СПбГУ, номинация \"История\"",
        {
    ...
    (
        "Я Кузнецова Ольга, 19 лет, из Челябинской области, город Челябинск, учусь в ЧелГУ, номинация \"Математика\"",
        {
    ...
    (
        "Меня зовут Григорьев Илья, 28 лет, из Ростовской области, город Ростов-на-Дону, учусь в РГЭУ, номинация \"Экономика\"",
        {
            "NAME": "Григорьев Илья",
            "AGE": "28",
    ...
    (
        "Я Лебедев Артем, 21 год, из Республики Татарстан, город Казань, учусь в КГУ, номинация \"Физика\"",
        {
            "NAME": "Лебедев Артем",
            "AGE": "21",
    ...
    (
        "Меня зовут Сидоров Дмитрий, 30 лет, из Нижегородской области, город Нижний Новгород, учусь в ННГУ, номинация \"Информатика\"",
        {
    ...
    (
        "Я Федорова Мария, 24 года, из Самарской области, город Самара, учусь в СГЭУ, номинация \"Экология\"",
        {
            "NAME": "Федорова Мария",
            "AGE": "24",
    ...
    (
        "Меня зовут Смирнов Олег, 22 года, из Красноярского края, город Красноярск, учусь в СФУ, номинация \"Химия\"",
        {
            "NAME": "Смирнов Олег",
            "AGE": "22",
    ...
    (
        "Меня зовут Никитин Дмитрий, 24 года, из Самарской области, город Тольятти, учусь в ТГУ, номинация \"Экология\"",
        {
